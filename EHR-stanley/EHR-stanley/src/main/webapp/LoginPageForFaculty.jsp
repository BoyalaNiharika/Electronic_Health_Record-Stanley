...
<%@ page import="java.sql.*" %>
      ...
      try {
       ...
       while(set.next())
       {
        ...
        if(flag==1)
        {
        	response.sendRedirect("FacultyApplicationForm.jsp");
        }
        else{
        	%>
            <script>
 ...
 <%
	...
	<div class="container">	
        <form id="form" action="LoginPageForFaculty.jsp" method="post">
            ...
            <a href="SignUpPageForFaculty.jsp">Create an account</a>
