...
window.addEventListener("load", function() {
	  ...
	  form.addEventListener("submit", function(event) {
	    ...
	    var catogeries = categoriesInput.value;
	    ...
	    if (catogeries==""){
			alert("Catogeries can not be Empty");
			catogeriesInput.focus();
	      	return;
	    }
	    if (age==""){
...
<body>
  <%@ page import="java.sql.*" %>
      ...
      try {
       ...
       String insertQuery = "INSERT INTO nonteachingfacultyapplicationdetails (FullName,PhoneNumber,parentsName,ParentsPhoneNumber,DateOfBirth,aadharno,email,address,categories,age,weight,height,bloodgroup,diabetic,BloodPressure,allergyhistory,accident,TypeofInjury,Hospitalized,healthissues,BloodTransfusion,eyesight,eyepower,asthama,frequentcold,TestedCovidPositive,vaccinated,VaccineDoses,TypeofCovidVaccine,gastricproblem,acidity,DonotedBloodBefore,How_often_DonatedBlood,Year_of_DonatedBlood,CardioVascular,CardioProblem,Ecosprin,medication,arthritis) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
       PreparedStatement ps = con.prepareStatement(insertQuery, Statement.RETURN_GENERATED_KEYS);
        ...
        ps.setString(19, hospitailzed);
        ps.setString(20, healthissue);
        ps.setString(21, bloodtransfer);
    ...
    %>
   	<div class="container">
        <form class="form" id="form"action="NonTeachingFacultyApplicationForm.jsp" method="post">
           	<center><h1><b><u>APPLICATION FORM</u></h1></b></center>
           	<fieldset>
				<legend>
                    <h3>
                        Non-Teaching Faculty Personal Details
                    </h3>
                 </legend>            
         ...
         <div class="choice">
                        <b>Categories :<span style="color:red;font-size:1.3em;">*</span></b>
           ...
           <div id="ratio_button">
            ...
            <div id="ratio_button">
            <b>were you ever Hospitailzed ?<span style="color:red;font-size:1.3em;">*</span></b>&nbsp;&nbsp;&nbsp;
            <input type="radio" name="hospitailzed" id="hospitailzed" value="Yes">
            <label>Yes</label>
            &nbsp;&nbsp;&nbsp;
            <input type="radio" name="hospitailzed" id="hospitailzed" value="No">
            <label>No</label>
          </div>
            <div class="input-control">
            ...
            <input type="radio" name="bloodtransfer" id="bloodtransfer" value="Yes">
            <label>Yes</label>
            &nbsp;&nbsp;&nbsp;
            <input type="radio" name="bloodtransfer" id="bloodtransfer" value="No">
            <label>No</label>
          </div>
          <div id="ratio_button">
