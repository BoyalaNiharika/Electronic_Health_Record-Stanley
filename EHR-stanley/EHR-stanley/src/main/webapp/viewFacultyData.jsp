...
td{width:300px;height:40px;text-align:center;}
tbody tr:nth-child(odd){background:#f2f2f2;}
/*body tr:hover{background:#b8e994;color:white;}*/

th:nth-child(1){width:200px;z-index:1;background:inherit;}
...
<body>
<div class="container">
	<form class="form" id="form" action=viewFacultyData.jsp>
...
<br>
<form class="forms" id="forms" action=viewFacultyData.jsp>
<div>
<table>
<thead>
<tr>
