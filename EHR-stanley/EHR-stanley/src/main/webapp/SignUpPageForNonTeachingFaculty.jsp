...
<%@ page import="java.sql.*" %>
      ...
      try {
       ...
       Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3308/ehrstanley","root","niharika");
        ...
        if(i>0)
        {
        	response.sendRedirect("LoginPageForNonTeachingFaculty.jsp");
        }
      } 
      catch (Exception e) {
 ...
 <%
	...
	<div class="container">	
        <form id="form" action="SignUpPageForNonTeachingFaculty.jsp" method="post">
            ...
            <a href="LoginPageForNonTeachingFaculty.jsp">Already have an account</a>
